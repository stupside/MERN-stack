...
export const Party: FC<{
    ...
    return <Link href={`/parties/${party.id}`} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-lg transition-all cursor-pointer group hover:scale-[1.02]">
