    ...
    return <div className="max-w-lg w-full mx-auto">
        <div className="bg-white rounded-2xl p-10 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
                <h1 className="text-4xl font-light text-gray-800 mb-2">Welcome back</h1>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                <p className="text-gray-600 text-sm">
                    New here? <Link href="/auth/register" className="text-red-500 hover:text-red-600 font-medium transition-colors">Create an account</Link>
                </p>
            </div>
        </div>
    </div>;
