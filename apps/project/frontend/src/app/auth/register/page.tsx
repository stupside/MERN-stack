    ...
    return <div className="max-w-lg w-full mx-auto">
        <div className="bg-white rounded-2xl p-10 shadow-xl border border-gray-100">
            ...
            <div className="mt-6 text-center">
                {isPending && <p className="text-red-500 text-sm">Creating your account...</p>}
            </div>
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                <p className="text-gray-600 text-sm">
                    Already have an account? <Link href="/auth/login" className="text-red-500 hover:text-red-600 font-medium transition-colors">Sign in</Link>
                </p>
            </div>
        </div>
    </div>;
